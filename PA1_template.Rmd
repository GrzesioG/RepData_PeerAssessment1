...
```{r histogram plot, echo=FALSE, message=FALSE, warning=FALSE}
library(ggplot2)
...
```{r histogram fixed plot, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r weekpart plot, echo=FALSE, message=FALSE, warning=FALSE}
